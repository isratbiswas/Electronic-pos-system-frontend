...
const steps = [
  {
    ...
    description: "Sign up and set up your store details within minutes.",
  },
  {
    icon: "📦",
    title: "Add Products",
    description: "Upload your items with stock, pricing, discounts & barcode.",
  },
  {
    icon: "💳",
    title: "Start Selling",
...
export default function HowItWorksSection() {
  ...
  return (
    <SectionWrapper className=" bg-slate-950">
      <section className=" md:px-12 lg:px-20" id="work">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:gap-30 gap-8 max-w-6xl mx-auto">
          {steps.map((step, i) => (
            <motion.div
              key={i}
